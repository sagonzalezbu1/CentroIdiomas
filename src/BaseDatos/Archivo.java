...
abstract public class Archivo {
	...
	//Añade un administrativo a la lista de administrativos, recibe como parametro un administrativo y no retorna nada
	static public void add(Administrativo a) {
		listaAdministrativos.add(a);
	}
	//Añade un curso a la lista de cursos, recibe como parametro un curso y no retorna nada
	static public void add(Curso c) {
		listaCursos.add(c);
	}
	//Añade un docente a la lista de docentes, recibe como parametro un docente y no retorna nada
	static public void add(Docente d) {
		listaDocentes.add(d);
	}
	//Añade un estudiante a la lista de estudiantes, recibe como parametro un estudiante y no retorna nada
	static public void add(Estudiante e) {
		listaEstudiantes.add(e);
	}
	//Añade una sugernecia a la lista de sugerencias, recibe como parametro una sugerencia y no retorna nada
	...
	/*Permite ver a todos los sugerencias creadas hasta el momento. No recibe ningun parametro. Retorna un String con formato correcto que contiene
	  al nombre y cedula de quien hizo la sugerencia acompañado del mensaje que escribio en esta de todas las sugerencias*/
